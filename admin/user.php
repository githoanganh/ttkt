...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Danh sách nhân viên</h3>
        </div>
    </div><!--/.row-->
    <div id="toolbar" class="btn-group">
        <a href="index.php?page_layout=add_user" class="btn btn-success">
            <i class="glyphicon glyphicon-plus"></i> Thành viên
        </a>
    </div>
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <table data-toolbar="#toolbar" data-toggle="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="label <?php  if($row['user_level']==1){echo 'label-success';}else if($row['user_level']==2){echo 'label-primary';}else{echo 'label-danger';} ?>"><?php  if($row['user_level']==1){echo 'Admin';}else if($row['user_level']==2){echo 'Manager';}else{echo 'Member';} ?></span></td>
                                <td class="form-group">
