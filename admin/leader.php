				...
				<div class="panel panel-default">
                    <div class="panel-body">
                        <?php 
                            ...
                            $query = mysqli_query($conn,$sql);
                        ?>
                        <form  action="index.php?page_layout=leader" method="GET">   
                            <h3>Tên nhân viên</h3>
                            <input type="hidden" name="page_layout" value="leader"/>
                            <select name="user_id"  >
                        ...
                        <table data-toolbar="#toolbar" data-toggle="table">
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if ($name != null) {
                                        $sql .= " where user_id = '$name'";
                                    }
                                    $sql .= " ORDER BY money_id ASC LIMIT $per_row,$rows_per_page";
                                    $query = mysqli_query($conn,$sql);
                                ...
                                <tr>
                                    ...
                                    <td class="form-group">
                                        <a href="index.php?page_layout=edit_leader&money_id=<?php echo $row['money_id']; ?>" class="btn btn-primary">
